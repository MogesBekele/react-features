...
const UseEffect = () => {
  ...
  return (
    <div id="useeffect" className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white p-8 pt-24">
