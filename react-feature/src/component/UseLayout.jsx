...
const UseLayout = () => {
  ...
  return (
    <div
      id="uselayout"
      className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white p-6"
    >
      ...
      <p className="text-lg mb-8 text-center max-w-2xl">
        ...
        <span className="font-semibold">useLayoutEffect</span> hook in React. It
        is used to measure the dimensions of a DOM element before the browser
        repaints.
      </p>
      <div
        ref={boxRef}
      ...
      <p className="text-lg mb-8 text-center max-w-2xl mx-auto">
        ...
        <span className="font-semibold">useLayoutEffect</span> hook to scroll a
        specific element into view when the component renders.
      </p>
