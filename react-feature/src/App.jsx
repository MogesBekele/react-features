...
const App = () => {
  return (
    <div>
      ...
      <UseEffect/>
      <UseRef/>
      <UseMemo items={["Item 1", "Item 2", "Item 3"]}/>
      <Footer/>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 text-white p-6">
      ...
      <p className="text-lg mb-8 text-center max-w-2xl">
        This is a demonstration of the <span className="font-semibold">useMemo</span> hook in React. It optimizes performance by memoizing the filtered list of items.
      </p>
